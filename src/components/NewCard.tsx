  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        className="outline-hidden shadow-sm text-sm rounded-lg w-full py-1 px-2 resize-none bg-white text-slate-900 placeholder:text-sm placeholder:text-slate-500 h-14"
        onKeyDown={(event) => {
          if (event.key === 'Enter') {
            event.preventDefault()
